  ...
  const accordionsData = [
    {
      ...
      description:
        "We offer a wide range of legal and professional services including Income Tax Consultancy, Accounting Services, Company Law & Corporate Affairs, Value Added Tax (VAT), and assistance with Bangladesh Investment Development Authority Affairs (BIDA), ERC, IRC, and Project Profile.",
    },
    {
      title:
        "How do you ensure compliance with Bangladeshi laws and regulations?",
      description:
        "Our team stays updated with the latest laws and regulations in Bangladesh, including the Companies Act, Trade Organization Act, and more. We work closely with clients to ensure their operations adhere to all legal requirements.",
    },
    {
      title: "Do you offer international accounting outsourcing services?",
      description:
        "Yes, we provide local and international accounting outsourcing services, ensuring efficient and accurate financial management for businesses of all sizes.",
    },
    {
      title: "How do you assist with tax-related matters?",
      description:
        "We provide comprehensive Income Tax Consultancy, helping clients understand and navigate their tax obligations, optimize their tax positions, and comply with relevant tax laws.",
    },
    {
      title:
      ...
      <div className="rounded-lg font-serif container mx-auto">
        ...
        {accordionsData.map((PerAccordion, idx) => (
          ...
          >
            <button
              onClick={() => toggle(idx)}
              className="flex h-full w-full items-center justify-between py-4 font-normal text-white"
            >
            ...
            >
              <div className="overflow-hidden text-white text-sm lg:text-[17px] text-start">
