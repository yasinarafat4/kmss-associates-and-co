      ...
      <div className="hero-content flex items-center justify-start text-neutral-content">
        <div>
          <h1 className="mb-5 text-2xl md:text-4xl lg:text-5xl font-bold">
            Welcome to <span className="text-[#2563EB] dark:text-white">KMSS</span> & <span className="text-[#FE322E] dark:text-white">Associates!</span>
          </h1>
          ...
          <div className="flex gap-4">
            <Link to={"/more-about-us"}>
              <button className="py-2 px-3 lg:px-4 text-xs md:text-base bg-[#2563EB] dark:bg-slate-800 text-white rounded-sm">
                My Company
              </button>
            </Link>
