  ...
  const accountingServiceData = [
    {
      ...
      description:
        "We record all financial transactions in the general ledger and prepare financial statements to reflect your business&apos; performance accurately.",
    },
    {
    ...
    <div>
      ...
      <div className="px-[20px] py-[10px] md:px-[100px] md:py-[30px] dark:bg-slate-700 dark:text-slate-200">
        <p className="text-md lg:text-lg">
          ...
          we strive to meet each client&apos; specific needs in planning for the
